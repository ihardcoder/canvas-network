...
/***/ function(module, exports, __webpack_require__) {
	...
	var canvas = (0, _jquery2.default)('<canvas></canvas>').appendTo('body')[0];
	...
	function updateCanvasSize() {
	  winW = (0, _jquery2.default)(window).width() * 0.8;
	  winH = (0, _jquery2.default)(window).height() * 0.6;
	  canvas.width = winW;
	  canvas.height = winH;
	  (0, _jquery2.default)(canvas).css({
	    position: 'absolute',
	    top: '50%',
	    left: '50%',
	    marginTop: -winH / 2,
